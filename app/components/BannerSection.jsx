...
const BannerSection = () => {
  ...
  return (
    <section className="banner-section bg-cover bg-no-repeat bg-center m-[4rem] gradient-radial max-[600px]:m-[0]" style={{ backgroundImage: `url(assets/img/banner-bg.png)` }}>
      <div className="container">
        <div className="banner-box text-white py-[10rem] px-[4rem] relative max-[600px]:py-[10rem] max-[600px]:px-[2rem]">
          ...
          <div className={`max-[600px]:hidden click-box-one absolute ${isContentVisibleOne ? "right-[35.8%] bottom-[18%]" : "right-[50%] bottom-[18%]"}`}>
            <div className={`click-content ${isContentVisibleOne ? "block" : "hidden"} relative after:content-["] after:absolute after:bottom-[-6rem] after:left-[1.7rem] after:h-[6rem] after:w-[0.2rem] after:bg-[#f68b41] text-black w-[20rem] rounded-[1rem] mb-[5rem] bg-[#fff] py-[2rem] px-[1.5rem]`}>
