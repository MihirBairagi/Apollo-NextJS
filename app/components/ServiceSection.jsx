...
const ServiceSection = () => {
  ...
  return (
   <>
    <section className="service-section my-[10rem] px-[5rem]
    max-[600px]:my-[5rem]
    max-[600px]:px-[2rem]
    " >
        <div className="container">
            <div className="service-box">
                <h2 className="uppercase text-[3rem] border-l-[0.3rem] border-[#F68B41] pl-[1.8rem] leading-[1.2] text-[#4A4A49] max-[600px]:text-[3rem]" >
                    <strong> we provide quality </strong><br className="max-[600px]:hidden" /> roofing service
                </h2>

                <ul  >
                    <Slider {...settings} className="service-listing flex my-[8rem] px-[3rem]
                    max-[600px]:my-[4rem]
                    max-[600px]:px-[1rem]
                    " >
                        <li className="group w-[33%] text-center p-[2rem] hover:bg-[#F5F5F5] min-h-[26rem] 
                            max-[600px]:min-h-[20rem]
                            max-[600px]:p-[2rem]
                            max-[600px]:py-[4rem]
                            max-[600px]:bg-[#f5f5f5]
                        ...
                        "  >    
                            <Image className="w-[6rem] mx-auto mb-[2rem] "
                                src="/assets/img/slide-img-1.png"
                                height={100}
                                width={100}
                            />
                            <h4 className="text-[2rem] mb-[1rem] font-[600]" >
                                Roofing Layers
                            </h4>
                            ...
                            <div className="btn-box">
                                <p className="hidden cursor-pointer group-hover:block hover:invert hover:bg-[#fff] hover:border-[#fff] px-[2.5rem] py-[0.8rem] border-[0.2rem] border-[#000] mt-[2rem] w-max mx-auto font-[600] text-[1.2rem]
                                    max-[600px]:block
